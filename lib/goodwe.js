...
function toVictronPayload(data, opts = {}) {
  const payload = {
    ...
    '/Ac/L1/Power': data.ac.power,
    '/Ac/L1/Energy/Forward': data.energy.total,
    '/StatusCode': data.statusCode,
    '/ErrorCode': 0,
  };
  if (data.ac.l1.voltage != null) payload['/Ac/L1/Voltage'] = data.ac.l1.voltage;
  if (data.ac.l1.current != null) payload['/Ac/L1/Current'] = data.ac.l1.current;
